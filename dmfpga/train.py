...
def fold_train(args, log):
    ...
    # 3) Build simple and effective model (best performance)
    ...
    # 5) Simple and effective training loop
    ...
    log.info(f"[{args.save_path}] Model saved to {model_path}")
    print(f"[Console] Model saved to {model_path}")

    # 7) Log tổng thời gian fold
